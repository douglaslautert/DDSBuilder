...
CHAT_API_KEY = "CHAT_API_KEY" # Replace with your ChatGPT API Key
LLAMA_API_KEY = "LLAMA_API_KEY" #replace with your llama API key from https://www.llama-api.com/
...
# Define a chave de API do ChatGPT como uma variável de ambiente
os.environ["CHAT_API_KEY"] = CHAT_API_KEY
# Define a chave de API do LLAMA como uma variável de ambiente
